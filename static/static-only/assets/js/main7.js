...
(function(){
  ...
  if(cart.length > 0) {
  	var cartAddBtns = document.querySelector('#detailbutton'),
        ...
        function addProduct(target, control) {
            ar href = document.querySelector('.javs-link').href;
            ...
            if(localStorage.getItem('products')){
                ...
                if(control){
                    ...
                    onsole.log("this is second control")
                    console.log(control)
                    if(control){
                        console.log("hehehe")
