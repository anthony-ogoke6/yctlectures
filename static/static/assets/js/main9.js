...
(function(){
  ...
  if(cart.length > 0) {
  	  var cartAddBtns = document.getElementsByClassName('js-cd-add-to-cart').innerHTML;
  	  console.log(cartAddBtns)
  	  console.log("hmmmmm")
      var cartAddBtns1 = document.querySelector('#clickonthis'),
        ...
        window.onload = function buttonclick(){
		    if(document.body.contains(document.querySelector('#clickonthis'))){
		...
		function initCartEvents() {
			...
			cartAddBtns1.addEventListener('click', addToCart);
		...
		function addProduct(target, control) {
			...
			if(document.body.contains(document.querySelector('.javs-name'))){
			//if(document.querySelector('.javs-name').innerHTML){
            ...
            if(localStorage.getItem('products')){
                console.log("this is second control")
                console.log(control)
                if(control){
                    console.log("hehehe")
                    var updateprod5 = JSON.parse(localStorage.getItem('products'));
                    Array.prototype.forEach.call(updateprod5, function(value, key) {
                ...
                if(control){
                    console.log("hehehe")
                    var updateprod4 = JSON.parse(localStorage.getItem('products'));
                } else {
                    products.push({'productId' : productId, image : image, name : prod_name, price: prod_price, qty:1});
                    localStorage.setItem('products', JSON.stringify(products));
