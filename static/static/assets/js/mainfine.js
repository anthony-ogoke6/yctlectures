...
(function(){
  ...
  if(cart.length > 0) {
  	var cartAddBtns = document.getElementsByClassName('js-cd-add-to-cart'),
  	    cartAddBtns1 = document.querySelector('#clickonthis'),
		...
		function buttonclick(){
            var pagebutton= document.querySelector('#clickonthis');
            pagebutton.click();
            };
		...
		function initCartEvents() {
			...
			cartAddBtns1.addEventListener('click', refreshAddProduct);
		...
		function refreshAddProduct(target) {
            ...
            if(localStorage.getItem('products')){
                ...
                Array.prototype.forEach.call(products, function(value, key) {
                        var productAdded = '<li class="cd-cart__product" data-id="'+ value.productId +'"><div class="cd-cart__image"><a href=""><img src="'+ value.image +'" alt="placeholder"></a></div><div class="cd-cart__details" data-id="'+ value.productId +'"><h3 class="truncate"><a href="#0">' + value.name + '</a></h3><span class="cd-cart__price">' + value.price + '</span><div class="cd-cart__actions"><a href="#0" class="cd-cart__delete-item">Delete</a><div class="cd-cart__quantity"><label for="cd-product-'+ value.productId +'" class="cd-cart__productId">Qty</label><span class="cd-cart__select"><select class="reset" id="cd-product-'+ value.productId +'" name="quantity" data-id=" '+ value.productId +' "><option id="cd-product1-'+ value.productId +'" value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select><svg class="icon" viewBox="0 0 12 12"><polyline fill="none" stroke="currentColor" points="2,4 6,8 10,4 "/></svg></span></div></div></div></li>';
		...
		function addProduct(target) {
			...
			//var all = document.querySelector('.cd-cart__product');
            ...
            if(localStorage.getItem('products')){
                ...
                if(ls.indexOf(Number(productId)) !== -1){
                    ...
                    Array.prototype.forEach.call(addednewprod, function(value, key) {
                        if(document.body.contains(document.querySelector('.cd-cart__body'))){
                            var all = document.querySelector('.cd-cart__body').children[0].getElementsByClassName('cd-cart__product');
                            for(var b=0;b < all.length; b++) {
                                var arrValue = all[b];
                                theArray.push(arrValue);
                            }
                            for(var c=0;c < theArray.length; c++) {
                                pid = theArray[c].getAttribute('data-id')
                                if(Number(value.productId) !== Number(pid)){
                                    var productAdded = '<li class="cd-cart__product" data-id="'+ value.productId +'"><div class="cd-cart__image"><a href=""><img src="'+ value.image +'" alt="placeholder"></a></div><div class="cd-cart__details"><h3 class="truncate"><a href="#0">' + value.name + '</a></h3><span class="cd-cart__price">' + value.price + '</span><div class="cd-cart__actions"><a href="#0" class="cd-cart__delete-item">Delete</a><div class="cd-cart__quantity"><label for="cd-product-'+ value.productId +'" class="cd-cart__productId">Qty</label><span class="cd-cart__select"><select class="reset" id="cd-product-'+ value.productId +'" name="quantity" data-id=" '+ value.productId +' "><option id="cd-product1-'+ value.productId +'" value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select><svg class="icon" viewBox="0 0 12 12"><polyline fill="none" stroke="currentColor" points="2,4 6,8 10,4 "/></svg></span></div></div></div></li>';
        			                cartList.insertAdjacentHTML('beforeend', productAdded);
                                }
                            }
                        }
                ...
                if(document.body.contains(document.querySelector('.cd-cart__body'))){
    			    var all = document.querySelector('.cd-cart__body').children[0].getElementsByClassName('cd-cart__product'); //[0].getAttribute('data-id'));
                ...
                for(var c=0;c < theArray.length; c++) {
                    console.log(Number(theArray[c].getAttribute('data-id')))
                }
