...
ModuleFormSet = inlineformset_factory(Department, Course, fields=['name', 'description'], extra=1, can_delete=True)

ModuleFormSet1 = inlineformset_factory(Course, Assignment, fields=['question', 'option1', 'option2', 'option3', 'option4', 'answer', 'show_question'], extra=1, can_delete=True)
