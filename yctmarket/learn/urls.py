...
urlpatterns = [
	...
	re_path(r'(?P<id>\d+)/(?P<slug>[\w-]+)/learn_login/$', students_views.learn_login, name="learn_login"),
    re_path(r'(?P<id>\d+)/(?P<slug>[\w-]+)/learn_register/$', students_views.learn_register, name="learn_register"),
