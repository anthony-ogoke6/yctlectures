...
class Department(models.Model):
    ...
    instructor = models.ForeignKey(User, on_delete=models.CASCADE, related_name='courses_created1')
    school = models.ForeignKey(School, on_delete=models.CASCADE, related_name='courses1')
    ...
    students = models.ManyToManyField(User, related_name='courses_joined1', blank=True)
    ...
    def get_absolute_url(self):
        return reverse("students1:student_department_detail", args=[self.pk])
    ...
    def save(self, *args, **kwargs):
        if not self.id and not self.slug:
            ...
            while slug_exists:
                try:
                    slug_exits = Department.objects.get(slug=slug)
                    if slug_exits:
...
class DepartmentalAccess(models.Model):
    ...
    course = models.ForeignKey(Department, null=True, blank=True, on_delete=models.CASCADE, related_name='Department_courses1')
...
class DepartmentalAccessLevel(models.Model):
    name = models.CharField(max_length=800, null=True, blank=True)
    course = models.ForeignKey(Department, null=True, blank=True, on_delete=models.CASCADE, related_name='Department1_level1')
    class Meta:
...
class Course(models.Model):
    course = models.ForeignKey(Department, on_delete=models.CASCADE, related_name='modules1')
    name = models.CharField(max_length=200)
...
class Assignment(models.Model):
    course = models.ForeignKey(Course, on_delete=models.CASCADE, related_name='assignments1')
    ...
    option16 = models.CharField(max_length=200, null=True, blank=True,)
...
class Score(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='user_assignment1')
    course = models.ForeignKey(Department, on_delete=models.CASCADE, related_name='score_department1')
    module = models.ForeignKey(Course, on_delete=models.CASCADE, related_name='score_course1')
    assignment = models.ForeignKey(Assignment, on_delete=models.CASCADE, related_name='score_assignments1')
    question = models.CharField(max_length=200, null=True, blank=True,)
...
class Content(models.Model):
    topic = models.ForeignKey(Course, on_delete=models.CASCADE, related_name='contents1')
    content_type = models.ForeignKey(ContentType, on_delete=models.CASCADE, related_name='content_type1', limit_choices_to={'model__in':('text', 'video', 'image', 'file')})
...
class ItemBase(models.Model):
    owner = models.ForeignKey(User, on_delete=models.CASCADE, related_name='%(class)s_related1')
    ...
    def render(self):
        return render_to_string('voting/content/{}.html'.format(self._meta.model_name), {'item': self})
...
class Comment(models.Model):
    course = models.ForeignKey(Course, on_delete=models.CASCADE, related_name='comments1')
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='commentors1')
    reply = models.ForeignKey('Comment', on_delete=models.CASCADE, null=True, related_name="replies1")
